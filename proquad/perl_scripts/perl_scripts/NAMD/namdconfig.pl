...
sub NamdRunsimsolvate{
   ...
   print $fh "cellBasisVector1 54.8969974518 0 0 \n";
   print $fh "cellBasisVector2 0 77.0 0 \n";
   print $fh "cellBasisVector3 0 0 88.5460014343 \n";
...
sub WriteCellBasisVector{
   ...
   print $fh "measure minmax \$everyone \n";
   print $fh "measure center \$everyone \n";
   print $fh "set minmax [measure minmax \$everyone] \n";
   print $fh "set vec [vecsub [lindex \$minmax 1] [lindex \$minmax 0]] \n";
   print $fh "puts \"cellBasisVector1 [lindex \$vec 0] 0 0\" \n";
   print $fh "puts \"cellBasisVector2 0 [lindex \$vec 1] 0\" \n";
   print $fh "puts \"cellBasisVector3 0 0 [lindex \$vec 2]\" \n";
   print $fh "set center [measure center \$everyone] \n";
   print $fh "puts \"cellOrigin \$center\" \n";
   print $fh "exit\n";
...
sub WriteFrames{
   ...
   print "Writing $fname \n";
   my $fh = util_write($fname);
   print $fh "mol load psf $PDBWBPSF.psf dcd $OUTPUTNAME.dcd \n";
   print $fh "set nf [molinfo top get numframes] \n";
   print $fh "for {set i 0 } {\$i < \$nf} {incr i} { \n";
   print $fh "[atomselect top all frame \$i] writepdb frame_\$i.pdb \n";
   print $fh "} \n";
   print $fh "exit\n";
}
...
sub WriteRmsd{
   ...
   my $fh = util_write($fname);
   print $fh "mol load psf $PDBWBPSF.psf dcd $OUTPUTNAME.dcd \n";
   print $fh "set outfile [open rmsd.dat w]; \n";
   print $fh "set nf [molinfo top get numframes] \n";
   print $fh "set frame0 [atomselect top \"protein and backbone and noh\" frame 0] \n";
   print $fh "set sel [atomselect top \"protein and backbone and noh\"] \n";
   print $fh "for {set i 1 } {\$i < \$nf } { incr i } { \n";
   print $fh "\$sel frame \$i \n";
   print $fh "\$sel move [measure fit \$sel \$frame0] \n";
   print $fh "puts \$outfile \"[measure rmsd \$sel \$frame0]\" \n";
   print $fh "} \n";
   print $fh "close \$outfile \n";
   print $fh "exit \n";
}
...
WriteCellBasisVector("cellBasisVector.vmd");
NamdRunsimsolvate("runsimsolvate.conf");

WriteFrames("writeframes.vmd");
WriteRmsd("rmsd.vmd");
...
print $ofhscript "  echo \"Running cellBasisVector\" ; vmd -dispdev text -e cellBasisVector.vmd > & ! cellBasisVector.log\n";
print $ofhscript "  \$SRC/NAMD/extractCentrefromminmax.pl -outf lll -log cellBasisVector.log -con runsimsolvate.conf \n";
