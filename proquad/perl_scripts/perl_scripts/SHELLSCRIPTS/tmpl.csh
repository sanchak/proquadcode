...
foreach i (`cat $list`)
    #echo " Running  ${BIN_HOME}/grep_info.pl -intech $tech -impl ${run} -outfile $report -design $i -what $4"
	echo -n "Design: $i : "
	${BIN_HOME}/grep_info.pl -intech $tech -impl ${run} -outfile $report -design $i -what $4
	echo ""
end 
